...
function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function componentDidMount() {
      ...
      setTimeout(function () {
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].staggerTo('canvas', 0.5, {
          x: 50,
          autoAlpha: 0,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Expo"].out
        });
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].staggerTo('.intro h1, .intro h2, .intro h3', 0.5, {
          x: 100,
          autoAlpha: 0,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Expo"].out
        });
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].staggerTo('.transition', 0.5, {
          width: window.innerWidth,
        ...
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].to(pageItem[0], 1, {
          left: window.innerWidth,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Power2"].out
        });
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].to(pageItem[1], 1, {
          left: 0,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Power2"].out
        });
      }, 3000);
...
//# sourceMappingURL=index.js.232d0dc4e1ade4ec49e1.hot-update.js.map