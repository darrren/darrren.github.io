...
function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function componentDidMount() {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].set('.transitionBox', {
        rotationZ: 35
      });
      setTimeout(function () {
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].staggerTo('canvas', 0.3, {
          x: 25,
          autoAlpha: 0,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Expo"].out
        });
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].staggerTo('.intro h1, .intro h2, .intro h3', 0.3, {
          x: 50,
          autoAlpha: 0,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Expo"].out
        });
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].staggerTo('.transition', 0.3, {
          width: window.innerWidth,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Expo"].in,
          onComplete: function onComplete() {// TweenMax.set('.transition', { left:'auto', right:0 })
            // TweenMax.to('.transition', 1, { width:0, ease:Expo.out })
          }
        }, 0.2, function () {
          ...
          gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].staggerTo('.transition', 0.4, {
            width: 0,
            ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Expo"].out
          }, -0.2);
        });
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].to(pageItem[0], 0.6, {
          left: window.innerWidth,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Power2"].out
        });
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].to(pageItem[1], 0.6, {
          left: 0,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Power2"].out
        });
      }, 3000);
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_style_js__WEBPACK_IMPORTED_MODULE_6__["HomeContainer"], {
        ...
        className: "transitionBox transition"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "transition"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "transition"
      }))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "pageItem home active"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "innerPage"
...
//# sourceMappingURL=index.js.47c53847cde18874b12c.hot-update.js.map