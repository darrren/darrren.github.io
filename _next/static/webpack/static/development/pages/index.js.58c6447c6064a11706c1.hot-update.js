...
function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function componentDidMount() {
      ...
      setTimeout(function () {
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].staggerTo('canvas', 0.4, {
          x: 25,
          autoAlpha: 0,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Expo"].out
        });
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].staggerTo('.intro h1, .intro h2, .intro h3', 0.4, {
          x: 50,
          autoAlpha: 0,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Expo"].out
        });
        ...
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].to(pageItem[0], 0.8, {
          left: window.innerWidth,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Power2"].out
        });
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].to(pageItem[1], 0.8, {
          left: 0,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Power2"].out
        });
      }, 3000);
...
//# sourceMappingURL=index.js.58c6447c6064a11706c1.hot-update.js.map