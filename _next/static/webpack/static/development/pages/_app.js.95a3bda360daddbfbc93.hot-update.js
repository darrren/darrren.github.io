...
var ActiveLink = function ActiveLink(_ref) {
  var children = _ref.children,
      ...
      href = _ref.href,
      params = _ref.params;
  var active = router.pathname.replace('/', '') === href;
  var className = active ? 'active-link' : 'inactive-link';
  console.log(router.pathname.replace('/', ''), href, className); //   const style = {
  //     marginRight: 10,
...
//# sourceMappingURL=_app.js.95a3bda360daddbfbc93.hot-update.js.map