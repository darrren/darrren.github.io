...
function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function componentDidMount() {
      ...
      setTimeout(function () {
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].to('.transition', 0.5, {
          width: window.innerWidth,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Power2"].out,
          onComplete: function onComplete() {// TweenMax.set('.transition', { left:'inherit', right:0 })
            // TweenMax.to('.transition', 1, { left:window.innerWidth, width:0, ease:Power2.out })
          }
        });
...
//# sourceMappingURL=index.js.dd6623ab3319cdc469fc.hot-update.js.map