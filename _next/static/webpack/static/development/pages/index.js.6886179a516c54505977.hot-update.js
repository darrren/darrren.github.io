...
function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function componentDidMount() {
      ...
      } // TweenMax.set('.transition', { width:window.innerWidth, left:-window.innerWidth })


      setTimeout(function () {
        gsap__WEBPACK_IMPORTED_MODULE_3__["TweenMax"].to('.transition', 0.4, {
          width: window.innerWidth,
          ease: gsap__WEBPACK_IMPORTED_MODULE_3__["Expo"].in,
      ...
      }, 3000); // TweenMax.set('.intro h1', { x:20, y:-10, rotationX:5, rotationY:-5, scale:0.85, autoAlpha:0, transformPerspective:200, transformOrigin:'100% 100%' })
...
//# sourceMappingURL=index.js.6886179a516c54505977.hot-update.js.map